...
const UserCartoutForm = ({ userId, checkedItems, onCancel }) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <div>
                <div className='cart-address-header'>Address</div>
            ...
            <div className="button-border payment-cancel" onClick={ handleCancelClick }>Cancel</div> 
            <button disabled={ isSubmitting } type="submit" className="button-full payment-proceed">

                ...
                <div className="profile-wrapper">
                    <div>
                        <div className='picture-section'>
                            ...
                            { profile.image && (
                                ( !imageUrl && <img src={ profile.image } className='profile-image'/> ) ||
                                ( isEditing && imageUrl && <img src={ imageUrl } className='profile-image'/> )
                            )}
                            { isEditing && 
                                ...
                                { formType === "seller" ? ( 
                                    ...
                                    <>
                                        <div className='profile-details-items'>
                                            <div className='section-icon'><i className="bi bi-person details-icon"></i></div>
                                            <div>
                                                <div className='section-details-header'>First Name</div>
                                                { !isEditing && <div>{ profile.first_name }</div> }
                                                { isEditing && <input {...register("first_name", {
                                                    required: "First name is required"
                                                })} type="text" id="first_name" name="first_name" className="profile-input" /> }
                                        ...
                                        <div className='profile-details-items'>
                                            <div className='section-icon'><i className="bi bi-person details-icon"></i></div>
                                            <div>
                                                <div className='section-details-header'>Last Name</div>
                                                { !isEditing && <div>{ profile.last_name }</div> }
                                                { isEditing && <input {...register("last_name", {
                                                    required: "Last name is required"
                                                })} type="text" id="last_name" name="last_name" className="profile-input" /> }
                                        ...
                                        <div className='profile-details-items'>
                                            <div className='section-icon'><i className="bi bi-person details-icon"></i></div>
                                            <div>
                                                <div className='section-details-header'>Address</div>
                                                { !isEditing && <div>{ profile.address }</div> }
                                                { isEditing && <input {...register("address", {
                                                    required: "Address is required"
                                                })} type="text" id="address" name="address" className="profile-input" /> }

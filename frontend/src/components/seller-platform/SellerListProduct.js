...
const SellerListProduct = () => {
    ...
    return (
        <div className='add-product-form-wrapper'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="form-container add-product-form">
                <div>
                ...
                <div>
                    ...
                    { imageUrl && <img src={ imageUrl } className='add-product-image'/> }
                ...
                <div>
                    ...
                    { categories && (
                        <select id="category_id" {...register('category_id')} className='category-select'>
                            {categories.map((c) => (
                ...
                <div>
                    ...
                    <div className="skin-type-options">
                        {skinTypes && skinTypes.map(type => (
                            <div
                                key={type.id}
                                className={`skin-type-option ${selectedSkinTypes.includes(type.id) ? 'selected-skin-type' : ''}`}
                ...
                <div>
                    ...
                    })} type="textarea" id="ingredients" name="ingredients" className='textarea-input'/>
                ...
                <div>
                    ...
                    })} type="textarea" id="description" name="description" className='textarea-input'/>
                ...
                <div>
                    ...
                    })} type="textarea" id="refund_policy" name="refund_policy" className='textarea-input'/>
